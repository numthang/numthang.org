    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            <span class="help-block pull-right">
                <a target="_blank" href="http://octobercms.com/help/site/projects#project-id"><?= __('How to find your Project ID') ?></a>
            </span>
            <label class="form-label" for="projectId"><?= __('Project ID') ?></label>
            <input
                name="project_id"
                type="text"
                class="form-control"
